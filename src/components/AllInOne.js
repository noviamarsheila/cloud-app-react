				...
				<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
					<div className="flex">
						...
						<div>
							...
							<p className="text-lg pt-2 pb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores maxime deserunt voluptatibus consequatur similique voluptates!</p>
						</div>
					</div>
					<div className="flex">
						<div>
